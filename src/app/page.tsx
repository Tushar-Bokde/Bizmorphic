  ...
  <>
   ...
   <main>
        ...
        <article>
            ...
            <section className="section hero" id="home" aria-label="hero">
                <div className="container">
                    ...
                    <div className="hero-banner">
                        <Image src="/assets/images/hero-banner.png" width="794" height="637" alt="hero banner"
                            className="w-100" />
                    </div>
                </div>
            </section>
                    ...
                    <ul className="grid-list">
                        <li>
                            <div className="service-card" style={{color:" 174, 77%, 50%"}}>
                                <div className="card-icon">
                                    <Image src="/assets/images/service-icon-1.png" width="30" height="30" loading="lazy"
                                        alt="service icon" />
                                </div>
                        ...
                        <li>
                            <div className="service-card" style={{color:" 267, 76%, 57%"}}>
                                <div className="card-icon">
                                    <Image src="/assets/images/service-icon-2.png" width="30" height="30" loading="lazy"
                                        alt="service icon" />
                                </div>
                        ...
                        <li>
                            <div className="service-card" style={{color:" 17, 100%, 68%"}}>
                                <div className="card-icon">
                                    <Image src="/assets/images/service-icon-3.png" width="30" height="30" loading="lazy"
                                        alt="service icon" />
                                </div>
                        ...
                        <li>
                            <div className="service-card" style={{color:" 343, 98%, 60%"}}>
                                <div className="card-icon">
                                    <Image src="/assets/images/service-icon-4.png" width="30" height="30" loading="lazy"
                                        alt="service icon" />
                                </div>
                        ...
                        <li>
                            <div className="service-card" style={{color:" 210, 100%, 53%"}}>
                                <div className="card-icon">
                                    <Image src="/assets/images/service-icon-5.png" width="30" height="30" loading="lazy"
                                        alt="service icon" />
                                </div>
                        ...
                        <li>
                            <div className="service-card" style={{color:" 157, 89%, 44%"}}>
                                <div className="card-icon">
                                    <Image src="/assets/images/service-icon-6.png" width="30" height="30" loading="lazy"
                                        alt="service icon" />
                                </div>
                        ...
                        <li>
                            <div className="service-card" style={{color: "52, 98%, 50%"}}>
                                <div className="card-icon">
                                    <Image src="/assets/images/service-icon-7.png" width="30" height="30" loading="lazy"
                                        alt="service icon" />
                                </div>
            ...
            <section className="section feature" id="feature" aria-label="feature">
                <div className="container">
                    <div className="feature-banner">
                        <Image src="/assets/images/feature-banner.png" width="582" height="585" loading="lazy"
                            ...
                            <li>
                                <div className="feature-card">
                                    ...
                                    <div>
                                        ...
                                        <p className="card-text">
                                            {"Unlock rapid innovation with our AI expertise, swiftly implementing "}<br/>
                    ...
                    <ul className="grid-list">
                        ...
                        <li>
                            <div className="project-card">
                                ...
                                <div className="card-banner Image-holder"  >
                                    <Image src="/assets/images/project-1.jpg" width="835" height="429" alt="Book art design" className="Image-cover"/>
                                </div>
                        ...
                        <li>
                            <div className="project-card">
                                ...
                                <div className="card-banner Image-holder" style={{width:" 416; --height: 429;"}}>
                                    <Image src="/assets/images/project-2.jpg" width="416" height="429" loading="lazy"
                                        alt="Graphic Design" className="Image-cover"/>
                                </div>
                        ...
                        <li>
                            <div className="project-card">
                                ...
                                <div className="card-banner Image-holder" style={{width:" 416; --height: 429;"}}>
                                    <Image src="/assets/images/project-3.jpg" width="416" height="429" loading="lazy"
                                        alt="3d Digital Art" className="Image-cover"/>
                                </div>
                        ...
                        <li>
                            <div className="project-card">
                                ...
                                <div className="card-banner Image-holder" style={{width:" 416; --height: 429;"}}>
                                    <Image src="/assets/images/project-4.jpg" width="416" height="429" loading="lazy"
                                        alt="Web Design" className="Image-cover"/>
                                </div>
                        ...
                        <li>
                            <div className="project-card">
                                ...
                                <div className="card-banner Image-holder" style={{width:" 416; --height: 429;"}}>
                                    <Image src="/assets/images/project-5.jpg" width="416" height="429" loading="lazy"
                                        alt="Mobile App Design" className="Image-cover"/>
                                </div>
            ...
            <section className="section newsletter has-bg-image" aria-label="newsletter" style={{backgroundImage: "url('./assets/images/newsletter-bg.jpg')"}} >
                <div className="container">
                    <div className="newsletter-banner">
                        <Image src="/assets/images/newsletter-banner.png" width="355" height="356" loading="lazy"
                    ...
                    <ul className="blog-list">
                        <li>
                            <div className="blog-card large">
                                <div className="card-banner">
                                    <Image src="/assets/images/blog-1.jpg" width="644" height="363" loading="lazy"
                                        alt="How to reduce AWS cost ..." className="Image-cover" />
                                </div>
                        ...
                        <li>
                            <div className="blog-card">
                                <div className="card-banner">
                                    <Image src="/assets/images/blog-2.jpg" width="202" height="162" loading="lazy"
                                        alt="Godaddy user flow solution for every individual" className="Image-cover" />
                                </div>
                        ...
                        <li>
                            <div className="blog-card">
                                <div className="card-banner">
                                    <Image src="/assets/images/blog-3.png" width="202" height="162" loading="lazy"
                                        alt="Business solution for every individual" className="Image-cover" />
                                </div>
                        ...
                        <li>
                            <div className="blog-card">
                                <div className="card-banner">
                                    <Image src="/assets/images/blog-4.png" width="202" height="162" loading="lazy"
                                        alt="How to gain pro experience ar figma update version" className="Image-cover" />
                                </div>
        ...
        <a href="#top" className="back-top-btn has-after active" aria-label="back to top" data-back-top-btn>
